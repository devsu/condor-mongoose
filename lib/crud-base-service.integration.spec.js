...
describe('base service', () => {
  ...
  beforeEach((done) => {
    ...
    newModel.save()
      .then((model) => {
        ...
        mongooseModel1.relatedModels.push(relatedModel);
        ...
        mongooseModel2.relatedModels.push(relatedModel);
  ...
  describe('list()', () => {
    ...
    fdescribe('queryRequest with include defined', () => {
      beforeEach(() => {
        const relatedModels1 = [relatedModel1, relatedModel2];
        model1.relatedModels = {'relatedModels': relatedModels1};
        const relatedModels2 = [relatedModel3];
        model2.relatedModels = {'relatedModels': relatedModels2};
        model3.relatedModels = {'relatedModels': []};
