...
describe('base service', () => {
  ...
  beforeEach((done) => {
    ...
    newModel.save()
      .then((model) => {
        ...
        defaultRelatedModel1.sampleId = model1.id;
  ...
  describe('list()', () => {
    ...
    fdescribe('queryRequest with include defined', () => {
      beforeEach(() => {
        queryRequest.include = [{'name':'relatedUpdates', 'modelName': 'RelatedUpdate'}];
      });
      ...
      it('should get documents with limit', (done) => {
        ...
        console.log('related1', relatedModel1);
        console.log('related2', relatedModel2);
        console.log('related3', relatedModel3);
