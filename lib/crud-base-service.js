...
module.exports = class CrudBaseService {
  ...
  static getModelObject(model, includes) {
    ...
    includes.forEach((include) => {
      if (object[include] instanceof Array) {
        ...
        object[include] = CrudBaseService.getObjectRelatedModel(object, include);
      }
    });
  ...
  static getObjectRelatedModel(object, include) {
    const objectRelatedModels = {};
    objectRelatedModels[include] = object[include];
    return objectRelatedModels;
  }
